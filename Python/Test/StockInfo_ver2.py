...
def TitleLst():
    titlelst = ["idx","종목코드","회사명","현재가","발행주식수","자사주", \
        ...
        "당이_16","당이_17","당이_18","당이_19","당이_20","당이_21","당이_22","당이_23", \
...
if __name__ == '__main__':
    ...
    options.add_argument("window-size=19x1080")
    ...
    # Debug
    InputData=[]
    for idx in range(start_idx, LenCodeNums):      
        ...
        #매출액  # //*[@id="highlight_D_Y"]/table/tbody/tr[1]/td[1]
        for j in range(1,9):
            try:
        ...
        #영업이익  //*[@id="highlight_D_Y"]/table/tbody/tr[2]/td[8]
        for j in range(1,9):
            try:
        ...
        # 당기순이익  //*[@id="highlight_D_Y"]/table/tbody/tr[4]/td[8]              
        for j in range(1,9):
            try:
