...
def ReadCode():
    ...
    ReadCodeNum = pd.read_excel(
        KospiFile, sheet_name="kospi", engine='openpyxl', dtype={"종목코드": str})
    CodeNums = ReadCodeNum["종목코드"].tolist()
    CompanyNames = ReadCodeNum["회사명"].tolist()

    KosdaqFile = 'kosdaq.xlsx'
    ReadCodeNum = pd.read_excel(
        KosdaqFile, sheet_name="kosdaq", engine='openpyxl', dtype={"종목코드": str})
...
if __name__ == '__main__':
    ...
    for idx in range(idx, LenCodeNums):
        ...
        InputData.append(driver.find_element_by_xpath(
            '//*[@id="svdMainGrid1"]/table/tbody/tr[1]/td[1]').text)
        # //*[@id="svdMainGrid1"]/table/tbody/tr[1]/td[1]/text()
        InputData.append(driver.find_element_by_xpath(
            '//*[@id="svdMainGrid1"]/table/tbody/tr[7]/td[1]').text)  # 발행주식수
        # //*[@id="svdMainGrid1"]/table/tbody/tr[7]/td[1]

        # 자사주 : 없을 때는 어떻게 하나?
        try:
            InputData.append(driver.find_element_by_xpath(
                '//*[@id="svdMainGrid4"]/table/tbody/tr[3]/td[1]').text)
        except:
            InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[1]/td[{j}]').text
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[2]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[4]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[7]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[8]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[9]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[10]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[12]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[17]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[18]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[19]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[22]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[23]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        for j in range(1, 9):
            try:
                temp = driver.find_element_by_xpath(
                    f'//*[@id="highlight_D_Y"]/table/tbody/tr[24]/td[{j}]').text
                InputData.append(temp)
                # print(temp)
            except:
                InputData.append("0")
        ...
        ResultDatadf = ResultDatadf.append(
            pd.Series(InputData, index=ResultDatadf.columns), ignore_index=True)

        idx += 1
        InputData.clear()
        if idx % 100 == 0:
            ResultDatadf.to_csv(
                f'Stock_{idx}_{nowDate}.csv', encoding='utf-8-sig')
            delay(10)
    # end for idx
